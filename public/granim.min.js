...
})(
  {
    1: [
      function(t, e, s) {
        ...
        function i(t) {
          this.getElement(t.element), (this.x1 = 0), (this.y1 = 0), (this.name =
            t.name || !1), (this.elToSetClassOn =
            t.elToSetClassOn || 'body'), (this.direction =
            t.direction || 'diagonal'), (this.isPausedWhenNotInView =
            t.isPausedWhenNotInView || !1), (this.opacity =
            t.opacity), (this.states = t.states), (this.stateTransitionSpeed =
            t.stateTransitionSpeed ||
            1e3), (this.previousTimeStamp = null), (this.progress = 0), (this.isPaused = !1), (this.isCleared = !1), (this.isPausedBecauseNotInView = !1), (this.iscurrentColorsSet = !1), (this.context = this.canvas.getContext(
            '2d'
          )), (this.channels = {}), (this.channelsIndex = 0), (this.activeState =
            t.defaultStateName ||
            'default-state'), (this.isChangingState = !1), (this.activeColors = []), (this.activeColorDiff = []), (this.activetransitionSpeed = null), (this.currentColors = []), this.eventPolyfill(), (this.events = {
          ...
          }), this.getDimensions(), this.canvas.setAttribute(
            'width',
            this.x1
          ), this.canvas.setAttribute(
            'height',
            this.y1
          ), this.setColors(), this.refreshColors(), window.addEventListener(
            'resize',
            ...
            this.callbacks.onStart(), this.canvas.dispatchEvent(
            this.events.start
          );
        }
        (i.prototype.setColors = t(
          './setColors.js'
        )), (i.prototype.eventPolyfill = t(
          './eventPolyfill.js'
        )), (i.prototype.colorDiff = t(
          './colorDiff.js'
        )), (i.prototype.hexToRgb = t(
          './hexToRgb.js'
        )), (i.prototype.setDirection = t(
          './setDirection.js'
        )), (i.prototype.makeGradient = t(
          './makeGradient.js'
        )), (i.prototype.getDimensions = t(
          './getDimensions.js'
        )), (i.prototype.getElement = t(
          './getElement.js'
        )), (i.prototype.animateColors = t(
          './animateColors.js'
        )), (i.prototype.getLightness = t(
          './getLightness.js'
        )), (i.prototype.refreshColors = t(
          './refreshColors.js'
        )), (i.prototype.changeState = t(
          './changeState.js'
        )), (i.prototype.pause = t('./pause.js')), (i.prototype.play = t(
          './play.js'
        )), (i.prototype.clear = t(
          './clear.js'
        )), (i.prototype.getCurrentColors = t(
          './getCurrentColors.js'
        )), (i.prototype.pauseWhenNotInView = t(
          './pauseWhenNotInView.js'
        )), (i.prototype.onResize = t('./onResize.js')), (e.exports = i);
      },
      {
        './animateColors.js': 2,
        './changeState.js': 3,
      ...
      function(t, e, s) {
        ...
        e.exports = function(t) {
          ...
          (null === this.previousTimeStamp || n) &&
            (this.previousTimeStamp = t), (this.progress =
            this.progress + (t - this.previousTimeStamp)), (e = (this.progress /
            this.activetransitionSpeed *
            100).toFixed(2)), (this.previousTimeStamp = t), this.refreshColors(
            e
          ), e < 100
            ? (this.animation = requestAnimationFrame(
                this.animateColors.bind(this)
          ...
          this.activeState !== t &&
            (
              ...
              this.states[t].gradients[0].forEach(function(n, o, a) {
                (e = i.hexToRgb(
                  i.states[t].gradients[0][o]
                )), (s = i.colorDiff(i.activeColors[o], e)), i.activeColorDiff.push(s);
              }),
              (this.activeState = t),
              this.play()
            );
        ...
        e.exports = function() {
          this.isPaused
            ...
            : cancelAnimationFrame(
                this.animation
              ), (this.isCleared = !0), this.context.clearRect(
            0,
            0,
            this.x1,
            this.y1
        ...
        e.exports = function() {
          ...
          return e.forEach(function(t, e, i) {
            ...
            (i =
              null === i
                ? e
                : i + e), n === s.length - 1 && (t = Math.round(i / (n + 1)));
          }), t >= 128 ? 'light' : 'dark';
        };
      },
      {}
          ...
          this.name &&
            ('light' === this.getLightness()
              ...
              : (
                ...
                )), (this.context.fillStyle = s), this.context.fillRect(
            0,
            0,
            this.x1,
            this.y1
      ...
      function(t, e, s) {
        ...
        e.exports = function() {
          this.getDimensions(), this.canvas.setAttribute(
            'width',
            this.x1
          ), this.canvas.setAttribute('height', this.y1), this.refreshColors();
        };
      },
      {}
    ],
    ...
    16: [
      function(t, e, s) {
        ...
        e.exports = function(t) {
          var e = 'isPausedBecauseNotInView' === t;
          e ||
            (this.isPaused = !1), (this.isCleared = !1), (this.animation = requestAnimationFrame(
            this.animateColors.bind(this)
          ));
        };
      },
        ...
        e.exports = function(t) {
          ...
          this.activeColors.forEach(function(n, o, a) {
            for (s = 0; s < 3; s++)
              (e =
                i.activeColors[o][s] +
                Math.ceil(i.activeColorDiff[o][s] / 100 * t)), e <= 255 &&
                e >= 0 &&
      ...
      function(t, e, s) {
        ...
        e.exports = function() {
          var t,
            e,
            s = this;
          return this.channels[this.activeState] ||
            (this.channels[this.activeState] = []), void 0 !==
